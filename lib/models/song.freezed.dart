...
class _$SongImpl with DiagnosticableTreeMixin implements _Song {
  ...
  final Map<String, List<String>> _chords;
  @override
  Map<String, List<String>> get chords {
    if (_chords is EqualUnmodifiableMapView) return _chords;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_chords);
  }

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Song(id: $id, title: $title, key: $key, artist: $artist, language: $language, tempo: $tempo, bpm: $bpm, songbookNumber: $songbookNumber, sections: $sections, lyrics: $lyrics, chords: $chords)';
  }
